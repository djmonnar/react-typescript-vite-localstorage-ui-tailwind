...
function roleStats(role: FactionWizardComposition['roles'][number], style: FactionWizardStyle) {
  ...
  const table = {
    melee: { hp: 115 + undeadHp, mp: 0, shield: 8 + machineShield, attack: 22, defense: 4, range: 1, moveSpeed: 3 + beastSpeed, attackSpeed: 1.05, unitCost: 2, iconType: 'sword' },
    ranged: { hp: 82 + arcaneHpPenalty, mp: 25, shield: 6 + machineShield, attack: 27, defense: 2, range: 4, moveSpeed: 2.6 + beastSpeed, attackSpeed: 0.9, unitCost: 3, iconType: 'bow' },
    tank: { hp: 190 + undeadHp, mp: 10, shield: 28 + machineShield, attack: 16, defense: 8, range: 1, moveSpeed: 2.1 + beastSpeed, attackSpeed: 0.7, unitCost: 4, iconType: 'shield' },
    support: { hp: 90 + arcaneHpPenalty, mp: 70, shield: 12 + machineShield, attack: 14, defense: 3, range: 3, moveSpeed: 2.5 + beastSpeed, attackSpeed: 0.75, unitCost: 3, iconType: 'heal' },
    elite: { hp: 130 + undeadHp, mp: 35, shield: 14 + machineShield, attack: 36, defense: 5, range: 3, moveSpeed: 2.7 + beastSpeed, attackSpeed: 0.85, unitCost: 5, iconType: 'artillery' },
    hero: { hp: 340 + undeadHp, mp: 90, shield: 45 + machineShield, attack: 48, defense: 10, range: style.id === 'arcane' ? 5 : 2, moveSpeed: 2.5 + beastSpeed, attackSpeed: 0.85, unitCost: 12, iconType: 'hero' },
